<h1 style="font-size:24px;color:blue;margin:0 0 15px 0;padding: 0 0 15px 0;border-bottom:1px dotted #EEE;font-family: Courier;">Comper Registration</h1>
<form action="register.php" method="post" id="registration">
    <fieldset>
        <div class="form-group">
            <input class="form-control" name="name" placeholder="Your Full Name" type="text"/><div id="name"></div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <input class="form-control" name="email" placeholder="Harvard email" type="text"/><div id="email"></div>
        </div>
        <div class="form-group">
            <input class="form-control" maxlength="10" name="cell" placeholder="Cell phone number (##########)" type="text"/><div style="color: #FF0000;" id="cell"></div>
        </div>
        <div class="form-group">
...
<div>
    alternatively, <a href="login.php">log in</a> or register as a <a href="registerd.php">director</a>.
</div>
